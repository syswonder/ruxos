...
// TODO: When wide characters implemented, remove annotations according to musl.
...
static int str_next(const char *str, size_t n, size_t *step)
{
	...
	// TODO: When wide characters implemented, remove annotation
	// if (str[0] >= 128U) {
	// 	wchar_t wc;
...
{
	// TODO: When wide characters implemented, remove annotation and delete next line
	// wchar_t wc;
    char wc;
	int inv = 0;
	p++;
